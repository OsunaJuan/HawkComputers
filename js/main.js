...
// Se añaden los productos a vender en la pagina
    ...
    //Listado de Cafes.
insertarProducto(ListadoCafes,1,"Cafe Brasil Catuai",500,25,"Cafe");
insertarProducto(ListadoCafes,2,"Cafe Colombia Guanes",500,25,"Cafe");
insertarProducto(ListadoCafes,3,"Cafe Blend Brasil Colombia",500,25,"Cafe");
insertarProducto(ListadoCafes,4,"Cafe Brasil Bourbon",500, 25, "Cafe");
insertarProducto(ListadoCafes,5,"Cafe Guatemala",500,25,"Cafe");
insertarProducto(ListadoCafes,6,"Cafe Etiopia", 500,25,"Cafe");

    //Listado de Capsulas

insertarProducto(ListadoCapsulas,7,"Capsulas de Cafe de especialidad Brasil ",650,25,"Capsulas");
insertarProducto(ListadoCapsulas,8,"Capsulas de Cafe de especialidad Colombia ",650,25,"Capsulas");
insertarProducto(ListadoCapsulas,9,"Capsulas de Cafe de especialidad Oreiras ",650,25,"Capsulas");
insertarProducto(ListadoCapsulas,10,"Capsulas de Cafe Caffetino Dolce ",650,25,"Capsulas");
insertarProducto(ListadoCapsulas,11,"Capsulas de Cafe Caffetino Nespresso ",650,25,"Capsulas");
